-- Implement new collection and deck building rules
-- Collection: Exotic(1), Legendary(2), Regular(4)
-- Deck: Exotic(1), Legendary(2), Regular(2), Size(30)
...
BEGIN
    ...
    AND pr.exotic = false  -- Don't double-update exotic legendaries
...
DO $$ 
BEGIN
  RAISE NOTICE '=== NEW COLLECTION & DECK RULES IMPLEMENTED ===';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '• Encourages collecting beyond deck building';
  RAISE NOTICE '• Allows for trading/crafting economy';
  RAISE NOTICE '• Balanced competitive play';
  RAISE NOTICE '• Future-proof for expansions';
END $$;