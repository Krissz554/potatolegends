-- CLEAN Hero System Setup - Potato King Only
-- Fixes function conflicts by dropping existing functions first

-- Drop existing trigger first (prevents function drop error)
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;

-- Drop ALL existing hero-related functions
...
-- Create the user signup trigger to give Potato King
