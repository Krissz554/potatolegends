-- EMERGENCY FIX FOR USER REGISTRATION
...
DELETE FROM registration_fix_results;

-- Step 1: Recreate the handle_new_user_signup function with better error handling
...
BEGIN
  ...
  BEGIN
    ...
    VALUES (NEW.id, 'potato_king', true)
...
-- Step 3: Ensure Potato King exists in heroes table
...
VALUES ('potato_king', 'Potato King', 'The mighty ruler of all potatoes!', 20, 1, 'Royal Decree', 'Deal 2 damage to any target, or restore 2 health to your hero.', 2, 'common', 'light')
...
-- Show all results
SELECT step, status, message, created_at FROM registration_fix_results ORDER BY id;